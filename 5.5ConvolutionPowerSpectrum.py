...
plt.plot(fft_freq[1:],data_fft[0][1:]**2, label = data_file[6:-4] + "KHz Wave", color="black") #FFT

plt.legend()
plt.title('Power Spectrum of 700 vs ' + data_file[6:-4] + " KHz Wave")
